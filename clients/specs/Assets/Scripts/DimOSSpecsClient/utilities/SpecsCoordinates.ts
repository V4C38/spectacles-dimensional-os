import type { Quat, Vec3, YawPose } from "../../DimOSARClient/websocket/protocolTypes";
import { normalizeQuat, rotateVecByQuat } from "../../DimOSARClient/localization/clientTrackingTransforms";
