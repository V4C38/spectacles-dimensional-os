...
export class PointCloudRenderer extends BaseScriptComponent {
  ...
  onAwake(): void {
    ...
    this._configureVisual(this.heightVisual, false);
  ...
  /** Offline debug preview — height + obstacle layers, no bridge required. */
  public showMockDebugCloud(anchorCm: vec3 = vec3.zero()): void {
