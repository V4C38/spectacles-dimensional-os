...
from dimos_xr.network.bridge_status import BridgeStatusSnapshot, BridgeStatusTracker
...
class StatusService:
    ...
    def start(self) -> None:
        ...
        self._thread = threading.Thread(target=loop, name="xr-stream-status", daemon=True)
        self._thread.start()
