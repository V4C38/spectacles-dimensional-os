"""PreviewGoalHandler — off-thread preview path planner and broadcaster."""
    ...
    def _process_request(self, request: PreviewPathRequest) -> None:
        try:
            ...
            if odom is None or not self._planner.has_costmap():
                ...
                return
            target_odom = self._world_frame.inverse_transform_point(request.target_world)
