import type { Alignment } from "../localization/alignment";
import {
  TextFramer,
  decodeLidar,
  decodeOutbound,
...
import type { Clock, Transport } from "./ports";
import type {
  Capabilities,
  Hello,
  Lidar,
...
type ViewListener = (view: SessionView) => void;
...
export class Session {
  ...
  view(): SessionView {
    return {
      ...
      aligned: this.alignment.aligned,
      hello: this.hello,
      state: this.state,
      pose: this.pose,
