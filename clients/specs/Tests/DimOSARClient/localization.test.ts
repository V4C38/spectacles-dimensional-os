...
} from "../../Assets/Scripts/DimOSARClient/localization/clientTrackingTransforms";
import {
  LocalizationCaptureEpisode,
  type LocalizationCaptureConfig,
} from "../../Assets/Scripts/DimOSARClient/localization/localizationCaptureEpisode";
import { passesGeometricGate } from "../../Assets/Scripts/DimOSARClient/localization/geometricGate";
import {
...
} from "../../Assets/Scripts/DimOSARClient/websocket/hostPorts";
import { decodeLocalizationObservations } from "../../Assets/Scripts/DimOSARClient/websocket/protocol";
...
describe("localization capture", () => {
  ...
  it("requestStart sends while idle and throws while capturing", () => {
    ...
    expect(controller.view().phase).toBe("capturing");
    expect(() => controller.requestStart()).toThrow(/already active/);
    expect(startRequestCount(transport)).toBe(1);
  });
